...
public class ThreeLanesActivity extends AppCompatActivity implements View.OnTouchListener, SensorEventListener {

    static final double NUMBER_OF_CAR_POS = 3.0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setUIVisibility();
        setContentView(R.layout.activity_three_lanes);
        ...
        coin_sound = MediaPlayer.create(ThreeLanesActivity.this, R.raw.coin_pickup);
        crash_sound = MediaPlayer.create(ThreeLanesActivity.this, R.raw.crash_sound);
        ...
        relativeLayout.post(() -> {
            ...
            carView = new View(ThreeLanesActivity.this);
    ...
    public void gameLoop() {
        handler.post(() -> {
            if (newRand == 0) {
                final View leftView = new View(ThreeLanesActivity.this);
                ...
                final View centerLeftView = new View(ThreeLanesActivity.this);
                ...
                final View centerView = new View(ThreeLanesActivity.this);
                ...
                final View centerRightView = new View(ThreeLanesActivity.this);
                ...
                final View rightView = new View(ThreeLanesActivity.this);
    ...
    public void coinLoop(){
        handler.post(() -> {
            if (coinRand == 0) {
                final View coinLeftView = new View(ThreeLanesActivity.this);
                ...
                final View coinCenterLeftView = new View(ThreeLanesActivity.this);
                ...
                final View coinCenterView = new View(ThreeLanesActivity.this);
                ...
                final View coinCenterRightView = new View(ThreeLanesActivity.this);
                ...
                final View coinRightView = new View(ThreeLanesActivity.this);
